...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - RoomBooking</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="flex h-screen">
        ...
        <div id="sidebar" class="hidden md:flex w-64 bg-gradient-to-b from-primary-800 via-primary-700 to-primary-900 text-white shadow-xl flex-col">
            <div class="p-6">
                ...
                <nav class="space-y-1">
                    <!-- Dashboard -->
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.dashboard') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
                        <i class="fas fa-tachometer-alt w-5 text-center"></i>
                        <span class="font-medium">Dashboard</span>
                    </a>

                    <!-- Kelola Akun -->
                    <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.users.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
                        <i class="fas fa-users-cog w-5 text-center"></i>
                        <span class="font-medium">Kelola Akun</span>
                    </a>

                    <!-- Kelola Ruangan -->
                    <a href="{{ route('admin.ruangan.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.ruangan.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
                        <i class="fas fa-building w-5 text-center"></i>
                        <span class="font-medium">Kelola Ruangan</span>
                    </a>

                    <!-- Jadwal Peminjaman -->
                    <a href="{{ route('admin.jadwal-peminjaman') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.jadwal-peminjaman') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
                        <i class="fas fa-calendar-check w-5 text-center"></i>
                        <span class="font-medium">Jadwal Peminjaman</span>
                    </a>

                    <!-- Laporan -->
                    <a href="{{ route('admin.laporan.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.laporan.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
                        <i class="fas fa-chart-bar w-5 text-center"></i>
                        <span class="font-medium">Laporan</span>
                    </a>

                    <!-- Log Aktivitas -->
                    <a href="{{ route('admin.log-aktivitas') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.log-aktivitas') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200">
            ...
            <div class="mt-auto p-4 border-t border-blue-700">
                ...
                <a href="{{ route('admin.profil.index') }}" 
                   class="flex items-center space-x-3 p-3 mb-2 {{ request()->routeIs('admin.profil*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200 group">
                    <div class="relative">
                        @if(auth()->user()->foto)
        ...
        <div id="mobileSidebar" class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-primary-800 via-primary-700 to-primary-900 text-white shadow-xl transform -translate-x-full transition-transform duration-300 ease-in-out z-50 md:hidden">
            <div class="p-6">
                ...
                <nav class="space-y-1">
                    <!-- Dashboard -->
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.dashboard') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-tachometer-alt w-5 text-center"></i>
                        <span class="font-medium">Dashboard</span>
                    </a>

                    <!-- Kelola Akun -->
                    <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.users.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-users-cog w-5 text-center"></i>
                        <span class="font-medium">Kelola Akun</span>
                    </a>

                    <!-- Kelola Ruangan -->
                    <a href="{{ route('admin.ruangan.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.ruangan.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-building w-5 text-center"></i>
                        <span class="font-medium">Kelola Ruangan</span>
                    </a>

                    <!-- Peminjaman Ruangan -->
                    <a href="{{ route('admin.peminjaman-ruangan.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.peminjaman-ruangan.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-door-open w-5 text-center"></i>
                        <span class="font-medium">Peminjaman Ruangan</span>
                    </a>

                    <!-- Jadwal Peminjaman -->
                    <a href="{{ route('admin.jadwal-peminjaman') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.jadwal-peminjaman') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-calendar-check w-5 text-center"></i>
                        <span class="font-medium">Jadwal Peminjaman</span>
                    </a>

                    <!-- Laporan -->
                    <a href="{{ route('admin.laporan.index') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.laporan.*') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-chart-bar w-5 text-center"></i>
                        <span class="font-medium">Laporan</span>
                    </a>

                    <!-- Log Aktivitas -->
                    <a href="{{ route('admin.log-aktivitas') }}" class="flex items-center space-x-3 p-3 {{ request()->routeIs('admin.log-aktivitas') ? 'bg-blue-700 bg-opacity-50 border-l-4 border-white' : 'hover:bg-blue-700 hover:bg-opacity-30 border-l-4 border-transparent' }} rounded-r-lg transition-all duration-200" onclick="closeMobileSidebar()">
                        <i class="fas fa-history w-5 text-center"></i>
                        <span class="font-medium">Log Aktivitas</span>
                    </a>
                </nav>
        ...
        <div class="flex-1 flex flex-col overflow-hidden w-full">
            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-6">
                ...
                <!-- Logout Success Notification (akan muncul setelah redirect dari logout) -->
            ...
            <div class="md:hidden bg-white border-t border-gray-200 py-2 px-4 shadow-inner">
                <div class="flex justify-between items-center">
                    <a href="{{ route('admin.dashboard') }}" class="flex flex-col items-center {{ request()->routeIs('admin.dashboard') ? 'text-blue-600 font-medium' : 'text-gray-600' }} transition-colors">
                        <i class="fas fa-home text-sm mb-1"></i>
                        <span class="text-xs">Dashboard</span>
                    </a>
                    <a href="{{ route('admin.users.index') }}" class="flex flex-col items-center {{ request()->routeIs('admin.users.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} transition-colors">
                        <i class="fas fa-users text-sm mb-1"></i>
                        <span class="text-xs">Akun</span>
                    </a>
                    <a href="{{ route('admin.peminjaman-ruangan.index') }}" class="flex flex-col items-center {{ request()->routeIs('admin.peminjaman-ruangan.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} transition-colors">
                        <i class="fas fa-door-open text-sm mb-1"></i>
                        <span class="text-xs">Ruangan</span>
                    </a>
                    <a href="{{ route('admin.laporan.index') }}" class="flex flex-col items-center {{ request()->routeIs('admin.laporan.*') ? 'text-blue-600 font-medium' : 'text-gray-600' }} transition-colors">
    ...
    <script>
        ...
        function showToast(type, title, message = '', duration = 5000) {
            ...
            const toastHTML = `
                <div id="${toastId}" class="toast-notification toast-${type} bg-${type === 'success' ? 'green' : type === 'info' ? 'blue' : type === 'warning' ? 'yellow' : 'red'}-50 border-l-4 border-${type === 'success' ? 'green' : type === 'info' ? 'blue' : type === 'warning' ? 'yellow' : 'red'}-500 rounded-lg shadow-lg p-4 toast-enter">
                    <div class="flex items-start">
                        <div class="flex-shrink-0 mr-3 toast-icon">
                            ${icon}
                        </div>
                        <div class="flex-1">
                    ...
                    <!-- Progress bar -->
                    <div class="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-${type === 'success' ? 'green' : type === 'info' ? 'blue' : type === 'warning' ? 'yellow' : 'red'}-500 to-${type === 'success' ? 'green' : type === 'info' ? 'primary' : type === 'warning' ? 'yellow' : 'red'}-600" style="width: 100%; animation: progressBar ${duration}ms linear forwards;"></div>
                </div>
            `;
