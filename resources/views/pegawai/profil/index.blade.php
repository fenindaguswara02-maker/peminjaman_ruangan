                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span id="passwordStrengthText" class="text-xs font-medium px-2 py-1 rounded-full bg-green-100 text-green-700">Sedang</span>
                            </div>
                            <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div id="passwordStrengthBar" class="h-full bg-green-500" style="width: 60%"></div>
                            </div>
                ...
                <form id="passwordForm">
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="mt-3 space-y-2">
                                ...
                                <div class="grid grid-cols-2 gap-2 mt-2">
                                    ...
                                    <div class="flex items-center text-xs">
                                        ...
                                        <span class="text-gray-500" id="req-upper-text">Huruf besar</span>
                                    </div>
                                    <div class="flex items-center text-xs">
                                        <i class="fas fa-circle text-gray-300 mr-1" id="req-lower" style="font-size: 6px;"></i>
                                        <span class="text-gray-500" id="req-lower-text">Huruf kecil</span>
                                    </div>
                                    <div class="flex items-center text-xs">
                                        <i class="fas fa-circle text-gray-300 mr-1" id="req-number" style="font-size: 6px;"></i>
                                        <span class="text-gray-500" id="req-number-text">Angka</span>
                                    </div>
                                    <div class="flex items-center text-xs">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-500 mt-1 hidden" id="confirmPasswordSuccess">Password cocok</p>
                        </div>
...
document.getElementById('photoUpload')?.addEventListener('change', function(e) {
    ...
    fetch('{{ route("pegawai.profil.upload-photo") }}', {
        method: 'POST',
        headers: {
...
function confirmDeletePhoto() {
    if (confirm('Apakah Anda yakin ingin menghapus foto profil?')) {
        fetch('{{ route("pegawai.profil.delete-photo") }}', {
            method: 'DELETE',
            headers: {
...
document.getElementById('passwordForm')?.addEventListener('submit', function(e) {
    ...
    fetch('{{ route("pegawai.profil.change-password") }}', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': csrfToken,
            'Content-Type': 'application/json',
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            document.querySelector('.text-gray-500.mt-2').innerHTML = '<i class="fas fa-info-circle mr-1"></i>Password terakhir diubah beberapa detik yang lalu';
        } else {
